...
export default function AnimatedBlobs() {
  return (
    <div className="absolute inset-0 w-full h-full -z-10 overflow-hidden pointer-events-none">
      {/* 藍色光斑 */}
      <div className="absolute left-1/4 top-[20%] w-[400px] h-[400px] bg-cyan-400 opacity-30 rounded-full blur-3xl animate-blob1" />
      {/* 紫色光斑 */}
      <div className="absolute right-1/4 top-1/4 w-[350px] h-[350px] bg-purple-400 opacity-30 rounded-full blur-3xl animate-blob2" />
      {/* 綠色光斑 */}
