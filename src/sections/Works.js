...
function WorkCard({ project, index, onReadMore, sectionProgress }) {
  ...
  const getAnimationPoints = () => {
    ...
    return {
      ...
      opacityPoints: [0, 0.5, 1, 1, 0.8, 0],
      xPoints: {
        image: [isEven ? -200 : 200, isEven ? -100 : 100, 0, 0, isEven ? -100 : 100, isEven ? -200 : 200],
        text: [isEven ? 200 : -200, isEven ? 100 : -100, 0, 0, isEven ? 100 : -100, isEven ? 200 : -200]
      }
    };
  };
